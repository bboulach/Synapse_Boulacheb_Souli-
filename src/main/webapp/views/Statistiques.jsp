...
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/news.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/slider.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/videos.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/blogs.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/achievement.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/recruitment.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/footer.css" />">
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/statistiques.css" />">
<link rel="stylesheet" type="text/css"
	...
	<div id="page-wrapper">
		...
		<div id="news-wrapper">
			...
			<div class="box">
				...
				<ul>
					<li><c:forEach items="${ClazzMostPlayed}" var="clazz">
							</br>${ clazz.name } </br></li>
					<li><img src="<c:url value="${ clazz.img }" />"
						title="${ clazz.name }" /> </c:forEach></li>
				</ul>
			</div>
			...
			<div class="box">
				...
				<ul>
					<li><c:forEach items="${RaceMostPlayed}" var="race">
							</br>
							</br>${ race.name } </br>
							</br>
						</c:forEach></li>
			...
			<div class="box">
				...
				<ul>
					<li><c:forEach items="${SpecializationMostPlayed}"
							var="specialization">
			...
			<div class="box">
				...
				<ul>
					<li><c:forEach items="${UsersWithoutPicture}"
							var="users_pictures">
			...
			<div class="box" id="actif">
				<h3>Les 5 utilisateurs les plus actifs</h3>

				<ul>
					<li><c:forEach items="${UsersMostActive}" var="users_active">
							</br>
